              ...
              <Route path="/" element={
                <div className="p-6 space-y-8">
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      <h1 className="text-2xl font-bold text-gray-800">Panel główny</h1>
                      <p className="text-gray-600">Przegląd działalności lombardu</p>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {/* Sekcja przypomnień */}
                    <div className="bg-white rounded-lg shadow-md p-6">
                      <h2 className="text-lg font-semibold text-gray-800 mb-4">Przypomnienia</h2>
                      <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-yellow-50 rounded-lg">
                          <div className="flex items-center">
                            ...
                            <div>
                              <p className="font-medium text-yellow-800">Zbliżający się termin wykupu</p>
                              <p className="text-sm text-yellow-600">5 zastawów wymaga uwagi</p>
                            </div>
                          </div>
                        ...
                        <div className="flex items-center justify-between p-4 bg-emerald-50 rounded-lg">
                          <div className="flex items-center">
                            ...
                            <div>
                              <p className="font-medium text-emerald-800">Nowe produkty</p>
                              <p className="text-sm text-emerald-600">3 produkty dodane dzisiaj</p>
                            </div>
                          </div>
